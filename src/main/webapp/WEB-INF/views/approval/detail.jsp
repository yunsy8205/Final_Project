										...
										<tbody>
											...
											<tr id="regDateRow">
												...
												<td
													style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; height: 25px; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: middle;"
													colspan="3">
													${approvalVO.startDate } ~ ${approvalVO.endDate }
													</td>
											...
											<tr>
												<td
													...
													style="font-weight: bold; font-family: &amp; amp; amp; amp; quot; malgun gothic&amp;amp; amp; amp; quot; , dotum , arial, tahoma; font-size: 11pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">휴가기준
